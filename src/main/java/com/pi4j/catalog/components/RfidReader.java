...
import com.pi4j.catalog.components.base.rfid.events.EventHandler;
...
import com.pi4j.catalog.components.base.rfid.MFRC522;
import com.pi4j.catalog.components.base.rfid.RfidCard;
...
public class RfidReader extends MFRC522 {
    /**
     * Default GPIO BCM address of reset pin for RFID component
     */
    protected static final PIN DEFAULT_RESET_PIN = PIN.D25;
    /**
    ...
    /**
     * Creates a new RFID reader with the default reset pin, channel and baud rate.
     *
     * @param pi4j Pi4J context
     */
    public RfidReader(Context pi4j) {
        this(pi4j, DEFAULT_RESET_PIN, DEFAULT_SPI_CHANNEL, DEFAULT_SPI_BAUD_RATE);
    }

    /**
     * Creates a new RFID reader with a custom channel, baud rate and no reset pin.
     *
     * @param pi4j       Pi4J context
     * @param spiChannel SPI channel
     * @param spiBaud    SPI baud rate
     */
    public RfidReader(Context pi4j, int spiChannel, int spiBaud) {
        this(pi4j, PIN.D25, spiChannel, spiBaud);
    }
    ...
    private final class Poller implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println("Ignoring unsupported RFID card type: " + e.getCardType());
            } catch (RfidException e) {
                // Reset the MFRC522 for any abnormal exceptions
                // This is required to ensure further operation is possible
                System.out.println("Resetting RFID component due to abnormal exception: " + e);
                reset();
            } finally {
