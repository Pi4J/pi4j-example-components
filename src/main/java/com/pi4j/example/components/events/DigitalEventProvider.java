 ...
 */
public interface DigitalEventProvider<V> extends ValueChangeProvider<DigitalEventListener<V>, V>, EventProvider<V> {
    /**
     ...
     */
    @Override
    default DigitalEventListener<V> addListener(ValueChangeHandler<V> handler) {
