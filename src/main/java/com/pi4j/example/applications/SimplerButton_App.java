...
import com.pi4j.example.components.SimplerButton;
 ...
 */
public class SimplerButton_App implements Application {
    @Override
    public void execute(Context pi4j) {
        // Initialize the button component
        final var button = new SimplerButton(pi4j, 26, Boolean.FALSE);
        ...
        button.onDown(null);
        button.onUp(null);
        button.whilePressed(10000, null);
    }
}